...
$messages = [
  'insert' => [
    'success' => ['icon' => 'success', 'title' => 'Thành công!', 'text' => 'Bài học đã được thêm.'],
    'error' => ['icon' => 'error', 'title' => 'Thất bại!', 'text' => 'Không thể thêm Bài học. Vui lòng thử lại.']
  ],
  'update' => [
    'success' => ['icon' => 'success', 'title' => 'Thành công!', 'text' => 'Bài học đã được cập nhật.'],
    'error' => ['icon' => 'error', 'title' => 'Thất bại!', 'text' => 'Không thể cập nhật Bài học. Vui lòng thử lại.']
  ],
  'delete' => [
    'success' => ['icon' => 'success', 'title' => 'Thành công!', 'text' => 'Bài học đã được xóa.'],
    'error' => ['icon' => 'error', 'title' => 'Thất bại!', 'text' => 'Không thể xóa Bài học. Vui lòng thử lại.']
  ]
];
