<div class="relative z-10 hidden" id="modal-alert" aria-labelledby="modal-title" role="dialog" aria-modal="true">
  <div class="fixed inset-0 bg-gray-500/75 transition-opacity" id="modal-alert-bg" aria-hidden="true"></div>
  <input type="text" id="course-id" class="hidden">
    ...
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      <div
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                <p id="modal-body" class="text-sm text-gray-500">Are you sure you want to deactivate your account? All
        ...
        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
          <button onclick="submitModalAlert()" id="modal-submit-btn" type="button"
          ...
          <button id="modal-close-btn" type="button" onclick="closeModalAlert()"
