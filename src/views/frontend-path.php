...
<body>
  <h1 style="color:red;text-align:center;font-size:50px;">Lộ trình để học Frontend</h1>
  <header>
    ...
    <div class="course-card">
      ...
      <div class="info">
        ...
        <p>Miễn phí</p>
        <a class="bg-[#007bff] px-2 py-1 rounded-md text-white mt-2 inline-block" href="/f8_clone/src/views/learning.php?slug=kien-thuc-nhap-mon">XEM KHÓA HỌC</a>
      </div>
    </div>
  </header>
  ...
  <section>
    ...
    <div class="course-card">
      <div class="thumbnail" style="background:blue;text-align:center">HTML,
        CSS từ Zero đến Hero</div>
      <div class="info">
